...
transcripts** (Claude Code, Codex, Claude Cowork, OpenCode, Jcode, GJC) per
project and **syncs them to the Tanka work-memory backend**.
...
- Discover sessions: Claude Code (`~/.claude/projects/`), Codex
  ...
  SQLite-backed project storage), Jcode (`~/.jcode/sessions/`), and GJC
  (`~/.gjc/agent/sessions/`).
